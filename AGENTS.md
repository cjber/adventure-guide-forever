...
- `Locales/enUS.lua` — every line the player reads (`ns.L`, constant keys); `Locales/Translations.lua` gets CurseForge's
  translations at release. After changing copy, `python3 tools/phrases.py > Locales/phrases.txt`.
