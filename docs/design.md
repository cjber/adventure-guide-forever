...
- **What a card may offer.** A card only ever holds eligible, recommendable steps. It never shows a lock, never shows "opens at level N", and never marks something new-in-Forever or of unknown location (§2.12's mark says new to the character). Locked quests appear only in search (§2.4).
...
- **Something new** (§2.12): "Duskwood is now for your level" sits under the quiet line, glowing once, until the
  guide opens.
...
14. Something new (§2.12): a level-up that brings a new next-zone card glows "<Zone> is now for your level" once,
