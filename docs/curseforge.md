...
- **Adventure Guide tab** on the world map's quest log: your level and rested XP, three zones that suit you under *Where next?*, and a suggested route of up to ten steps you can scroll and search, each with the reason it is there.
