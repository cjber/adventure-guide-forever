...
- **Adventure Guide tab** on the world map's quest log: your level and rested XP, three zones that suit you under *Where next?*, and a suggested route of three to five steps, each with the reason it is there.
