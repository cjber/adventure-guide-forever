...
-- "Something new" (docs/design.md §2.12): after a level gained or a zone entered, a journey card or an aside the
...
-- "Duskwood is now for your level": a zone by the client's name, a dungeon by its card's.
