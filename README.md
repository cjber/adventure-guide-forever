...
- **Your say in the route**: right-click a step for *Not this quest* and that quest stays off every route on this character. It stays in your log. Shift-click a quest giver's "!" on the map, or a quest in the search, to add it to your route, and a star marks it in the search. A quest you add in another zone goes on *Loose ends*.
