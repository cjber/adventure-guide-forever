...
def generate(tables, ui_maps, assignments, valid_ids, path_nodes, taxi_nodes, area_rows, map_rows):
    ...
    return emitted, zones, named, centres, shifts, ferries, counts
...
def render(quests, zones, instances, centres, shifts, ferries):
    lines = [
...
def main():
    ...
    quests, zones, instances, centres, shifts, ferries, counts = generate(
        tables,
    ...
    OUTPUT.write_text(render(quests, zones, instances, centres, shifts, ferries), encoding="utf-8")
