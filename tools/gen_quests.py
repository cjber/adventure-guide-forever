...
def generate(
    ...
    return emitted, zones, named, centres, shifts, ferries, towns, npcs, gates, explorable, counts
...
def render(quests, zones, instances, centres, shifts, ferries, towns, npcs, gates, explorable):
    lines = [
...
def main():
    ...
    quests, zones, instances, centres, shifts, ferries, towns, npcs, gates, explorable, counts = generate(
        tables,
    ...
    OUTPUT.write_text(
        render(quests, zones, instances, centres, shifts, ferries, towns, npcs, gates, explorable), encoding="utf-8"
    )
